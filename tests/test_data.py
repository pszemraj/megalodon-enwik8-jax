...
class TestLoadEnwik8:
    ...
    def test_load_split_sizes(self):
...
class TestSampleBatch:
    ...
    def test_sample_batch_dtype(self, rng):
    ...
    def test_sample_batch_values(self, rng):
    ...
    def test_labels_shifted_by_one(self, rng):
...
class TestSampleAccumBatch:
    ...
    def test_accum_batch_shapes(self, rng):
    ...
    def test_accum_batch_dtype(self, rng):
...
class TestEncodeDecodeTokens:
    ...
    def test_encode_byte_values(self):
    ...
    def test_decode_handles_special_chars(self):
