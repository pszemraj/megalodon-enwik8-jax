...
class TestLoadEnwik8:
    ...
    def test_load_returns_uint8(self, tiny_enwik8_path: str) -> None:
        """load_enwik8 returns uint8 arrays."""
        train, val = load_enwik8(tiny_enwik8_path)
        assert train.dtype == np.uint8
        assert val.dtype == np.uint8

    def test_load_split_sizes(self, tiny_enwik8_path: str) -> None:
    ...
    def test_values_in_byte_range(self, tiny_enwik8_path: str) -> None:
...
class TestSampleBatch:
    ...
    def test_sample_batch_shapes(
        ...
        tiny_enwik8_path: str,
    ) -> None:
        """sample_batch returns correct shapes."""
        train, _ = load_enwik8(tiny_enwik8_path)
